...
INSERT INTO public.produtos
    (id, nome, descricao, preco, custo, tipo, categoria, tamanhos, imagens, estoque, destaque, novo, encomenda, prazo_encomenda, badge_extra, ativo, criado_em, agendamento)
...
VALUES
    ...
    (7, 'Bottons personalizados',
     ...
     44, true, true, false, '', '', true, '21/03/2026, 18:28:06', ''),
    ...
    (8, 'Botton modelo 1 (cópia) (cópia)',
     ...
     '',
     44, true, true, false, '', '', false, '21/03/2026, 18:19:52', ''),
    ...
    (9, 'Botton modelo 1 (cópia) (cópia) (cópia)',
     ...
     'Nupieepro,Engenheiro de planilhas,Just-in-time,Foco em resultados,Engenharia de produção',
     '',
     44, true, true, false, '', '', false, '21/03/2026, 18:20:05', ''),
    ...
    (10, 'Botton modelo 1 (cópia) (cópia) (cópia) (cópia)',
     ...
     'Nupieepro,Engenheiro de planilhas,Just-in-time,Foco em resultados,Engenharia de produção',
     '',
     44, true, true, false, '', '', false, '21/03/2026, 18:29:23', ''),
...
INSERT INTO public.cupons (codigo, tipo, valor, minimo, limite, usos, descricao, produtos_restringidos, ativo, criado_em)
VALUES
    ('CALOUROEP10', 'percentual', 10, 0, 42, 2,
     ...
     '4,5,2006', true, '19/03/2026, 11:09:11'),

    ('DESCONTO15NUPI', 'percentual', 15, 0, 500, 0,
     '',
     '4,5,6,7,8,9,10,11', true, '27/04/2026, 07:40:57')
...
INSERT INTO public.pedidos
    (numero, data, status, pago, nome, whatsapp, email, entrega, endereco, pagamento, itens, subtotal, desconto, cupom, total, observacao, anotacao_interna)
VALUES

-- Pedidos históricos
('2026-001', '19/03/2026, 09:53:34', 'cancelado', true, 'Rayan', '86999880958', '', 'Retirada UFPI', 'Rua Inês', 'PIX', '[{"id":1,"nome":"Camisa PRETA — Eng. Produção","descricao":"Camisa oficial do NUPIEEPRO. 100% algodão, corte regular. Produto feito sob encomenda.","preco":40,"tipo":"camisa","categoria":"camisa","tamanhos":["P - Normal","M - Normal","G - Normal","GG - Normal","P - BBL","M - BBL","G - BBL","GG - BBL"],"imagens":["https://i.ibb.co/TDhnM6xW/unnamed.png"],"estoque":99,"destaque":true,"novo":false,"encomenda":true,"prazo_encomenda":"Apenas sob encomenda","badge_extra":"","img":["https://i.ibb.co/TDhnM6xW/unnamed.png"],"tamanho":"P - Normal","qtd":1}]', 40, 0, '', 40, '', ''),
